...
def apply_bow(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
    ...
    try:
        ...
        # Ensure labels are numeric (handles case where upstream replace(..., inplace=True)
        # failed silently on a DataFrame slice)
        ...
        if y_train.dtype == object:
            ...
            logger.debug('String labels mapped to numeric (happiness=1, sadness=0)')
